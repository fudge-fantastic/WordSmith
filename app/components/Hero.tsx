          ...
          <div className="h-full overflow-hidden rounded-b-3xl">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h1 className="text-xl p-1 font-raleway font-semibold text-vanila_text my-2">Between Earth and Eternity</h1>
              </div>
            </div>
        ...
        <div className="bg-red_vanila rounded-3xl group">
          <div className="m-4 p-1">
            ...
            <div className="flex justify-between items-center mt-3 mb-1">
              <h1 className="font-raleway font-semibold text-xl"><UnderlineLink underlineColor="#342415">Portfolio</UnderlineLink></h1>
            </div>
