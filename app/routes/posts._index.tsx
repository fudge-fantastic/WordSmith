        ...
        <div className="mx-auto container min-h-screen">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                {sharedData.map((item: Posts) => (
                    <div key={item.id} className="relative flex flex-col justify-between m-2 bg-vanila text-vanila_text p-4 rounded-xl">
                        <div>
                        ...
                        <button className="text-sm font-semibold mt-3 mb-2">
